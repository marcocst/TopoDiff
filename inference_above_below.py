...
from utils_above_below import compute_location_loss, Pharse2idx, draw_box, setup_logger
import hydra
import os
...
def main(cfg):
    ...
    # ------------------ example input ------------------
    examples = {"prompt": "A hat and a ball and a dog on the grass", #"A hello kitty toy is playing with a purple ball on the right.",
                "phrases": "hat^dog^ball",
                "locations": ["left", "mid", "major"],
